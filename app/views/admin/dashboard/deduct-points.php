...
<body class="bg-gray-50">
    ...
    <div class="container mx-auto px-4 py-8 max-w-2xl">
        <div class="bg-white rounded-lg shadow-md p-8">
            <div class="mb-6">
                <h1 class="text-3xl font-bold text-gray-900">Kurangi Poin</h1>
                <p class="text-gray-600 mt-2">Kurangi poin dari user</p>
            </div>
            ...
            <form method="POST" class="space-y-6">
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">
                        <i class="fas fa-minus-circle mr-2"></i>Jumlah Poin <span class="text-red-600">*</span>
                    </label>
                    <input 
                        type="number" 
                        name="points" 
                        min="1"
                        max="999999"
                        placeholder="Masukkan jumlah poin yang akan dikurangi"
                        required
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"
                    />
                </div>
                ...
                <div>
                    ...
                    <textarea 
                        name="reason" 
                        placeholder="Alasan pengurangan poin (misal: Dispute, Violation, dll)"
                        required
                        rows="3"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"
                    ></textarea>
