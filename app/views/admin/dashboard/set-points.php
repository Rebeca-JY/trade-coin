...
<body class="bg-gray-50">
    ...
    <div class="container mx-auto px-4 py-8 max-w-2xl">
        <div class="bg-white rounded-lg shadow-md p-8">
            <div class="mb-6">
                <h1 class="text-3xl font-bold text-gray-900">Set Poin User</h1>
                <p class="text-gray-600 mt-2">Ubah total poin user ke nilai tertentu</p>
            </div>
            ...
            <form method="POST" class="space-y-6">
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">
                        <i class="fas fa-star mr-2"></i>Total Poin Baru <span class="text-red-600">*</span>
                    </label>
                    <input 
                        type="number" 
                        name="points" 
                        min="0"
                        max="999999"
                        placeholder="Masukkan total poin yang baru"
                        required
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                    <p class="text-xs text-gray-500 mt-1">Poin tidak boleh negatif</p>
                </div>
                ...
                <div>
                    ...
                    <textarea 
                        name="reason" 
                        placeholder="Alasan perubahan poin (misal: Adjustment, Correction, dll)"
                        required
                        rows="3"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ></textarea>
