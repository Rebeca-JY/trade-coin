    ...
    <div class="max-w-4xl mx-auto py-10 px-4">
        <header class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="text-slate-600">Ubah data produk yang sudah tersimpan.</p>
            </div>
        ...
        <form action="/admin/products/<?= htmlspecialchars($product['id'] ?? '') ?>/edit" method="POST" class="space-y-6 rounded-3xl bg-white p-8 shadow-sm border border-slate-200">
            ...
            <button type="submit" class="inline-flex items-center justify-center rounded-full bg-sky-600 px-6 py-3 text-sm font-semibold text-white hover:bg-sky-700 transition">
                <i class="fa-solid fa-pen-to-square mr-2"></i> Simpan Perubahan
            </button>
        </form>
    </div>
</body>
